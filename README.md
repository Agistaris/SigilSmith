...
Roadmap:
- Multi-game support is coming via an open adapter template.

Support:
- GitHub Sponsors and Ko-fi links will be added soon.

Source:
- This repo hosts release artifacts only. Source code is currently private.
